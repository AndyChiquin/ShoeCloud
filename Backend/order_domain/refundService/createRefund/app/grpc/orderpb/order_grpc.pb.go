...
const (
	OrderService_CheckOrder_FullMethodName = "/orderpb.OrderService/CheckOrder"
)
...
//
// Servicio expuesto por orderService
...
func (c *orderServiceClient) CheckOrder(ctx context.Context, in *CheckOrderRequest, opts ...grpc.CallOption) (*CheckOrderResponse, error) {
...
func (UnimplementedOrderServiceServer) CheckOrder(context.Context, *CheckOrderRequest) (*CheckOrderResponse, error) {
...
func _OrderService_CheckOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).CheckOrder(ctx, req.(*CheckOrderRequest))
	}
